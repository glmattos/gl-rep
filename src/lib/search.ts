...
const ALIASES: Record<string, string[]> = {
  ...
  africa: ["áfrica", "tanzânia", "tanzania", "kilimanjaro", "safari", "namibia", "namíbia", "quenia", "quênia", "uganda", "mauritius"],
  áfrica: ["africa", "tanzânia", "tanzania", "kilimanjaro", "safari", "namibia", "namíbia", "quenia", "quênia", "uganda"],
  oceania: ["oceânia", "australia", "austrália", "nova zelandia", "nova zelândia"],
  oceânia: ["oceania", "australia", "austrália", "nova zelandia", "nova zelândia"],
  australia: ["austrália", "oceania", "oceânia"],
  austrália: ["australia", "oceania", "oceânia"],
  namibia: ["namíbia", "africa", "áfrica"],
  namíbia: ["namibia", "africa", "áfrica"],
  maldivas: ["asia", "ásia", "niyama"],
  mexico: ["méxico", "cidade do mexico"],
  méxico: ["mexico", "cidade do mexico"],
  islandia: ["islândia", "reykjavik", "europa"],
  islândia: ["islandia", "reykjavik", "europa"],
  uganda: ["africa", "áfrica", "primatas"],
  quenia: ["quênia", "porini", "safari", "africa", "áfrica"],
  quêania: ["quenia", "porini", "safari"],
  tailandia: ["tailândia", "phuket", "asia", "ásia"],
  tailândia: ["tailandia", "phuket"],
  butao: ["butão", "nepal", "caminhos sagrados"],
  butão: ["butao", "nepal"],
